...
}:
{
  ...
  '';
    ...
    # 笔记/阅读：obsidian、z-library、readest
    ...
    home.packages = builtins.attrValues {
      inherit (pkgs) brave pywalfox-native telegram-desktop discord qq wechat obsidian obs-studio krita z-library-desktop readest vscode opencode pi-coding-agent uv python3 gopeed localsend go-musicfox remmina gamescope prismlauncher protonplus lutris heroic winetricks waydroid-helper;
